# Generated by Django 4.0.3 on 2022-07-11 10:34
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('goodStatus', models.CharField(choices=[('Good', 'Good'), ('New', 'New'), ('Fail', 'Fail'), ('Scrap', 'Scrap'), ('Other', 'Other')], default='Other', max_length=5)),
                ('sparePartType', models.CharField(choices=[('Product', 'Product'), ('Spare', 'Sparepart'), ('Other', 'Other')], default='Other', max_length=7)),
