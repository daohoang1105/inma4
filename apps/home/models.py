...
class AllSparePart(models.Model):
    ...
    goodStatus = models.CharField(max_length=5, choices=Status.choices, default=Status.other)
    sparePartType = models.CharField(max_length=7, choices=SpareType.choices, default=SpareType.other)
